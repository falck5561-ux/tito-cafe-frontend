...
    // --- CORRECCIÓN 2.1: REFERENCIA PARA EL SCROLL ---
    const contentRef = React.useRef(null);
    
    // --- CORRECCIÓN 2.2: SCROLL AUTOMÁTICO AL CAMBIAR VISTA ---
    useEffect(() => {
        // Se asegura de que el contenido se desplace al tope al cambiar de vista ('cart' -> 'address')
...
                                {/* CORRECCIÓN 4: Se asume que MapSelector corregirá la instrucción de Ctrl+Scroll internamente. */}
                                <MapSelector 
...
                            </div>
                            
                            {/* Checkbox de Guardado (Ahora guarda dirección Y teléfono) */}
...
                    // CORRECCIÓN 3.3: Cargar el teléfono guardado al inicio si existe
...
        setDireccion(null); 
        setReferencia(''); 
        setTelefono(''); // CORRECCIÓN 3: Limpiar teléfono
...
            }
            // CORRECCIÓN 3: Cargar teléfono guardado
...
                referencia,
                telefono // CORRECCIÓN 3: Enviando teléfono al backend
            };
            
...
            try { 
                // CORRECCIÓN 3: Guardando dirección Y teléfono
...
                        // CORRECCIÓN 1: Asegura que el modal esté centrado horizontalmente
                        className="modal-dialog modal-dialog-centered d-flex justify-content-center mx-3" 
                    >
