...
import LocationModal from './LocationModal'; // <--- 1. Importamos el Modal

// --- COMPONENTE DE ENLACES DEL MENÚ ---
// Recibimos una nueva prop: onLocationClick para abrir el mapa
const MenuLinks = ({ onLinkClick, onLocationClick }) => {
  ...
  // Manejador para el botón de Ubicación
...
function Navbar() {
  ...
  // 2. Estado para controlar si el mapa está visible
  ...
  return (
    <>
          ...
          >
            ...
            <div className="offcanvas-body d-flex flex-column">
              <ul className="navbar-nav flex-grow-1">
                {/* Pasamos ambas funciones al menú móvil */}
                <MenuLinks 
      ...
      {/* 3. Renderizamos el Modal fuera de la estructura nav, pero dentro del fragmento */}
      <LocationModal 
        isOpen={isMapOpen} 
